class ChampionsController < ApplicationController
  ...
  # GET /champions/new
  def new
    @champion = @summoner.champions.build
  end
  ...
  # POST /champions.json
  def create
    @champion =@summoner.champions.build(champion_params)

    respond_to do |format|
      if @champion.save
        format.html { redirect_to [@summoner, @champion], notice: 'Champion was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @champion.update(champion_params)
        format.html { redirect_to [@summoner, @champion], notice: 'Champion was successfully updated.' }
  ...
  def destroy
    @champion.destroy
    respond_to do |format|
      format.html { redirect_to summoner_champions_url(@summoner), notice: 'Champion was successfully destroyed.' }
